...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div></section><section class="py-20 bg-navy-900"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><p class="section-label text-brand-400">Multi-Entity</p><h2 class="text-3xl md:text-4xl font-bold text-white mb-5">Manage all your entities in one place</h2><p class="text-white/60 text-lg mb-12 max-w-2xl mx-auto"> Whether you have 2 or 200 legal entities across multiple countries, Altisry gives your treasury team consolidated visibility and control. </p><div class="grid grid-cols-1 md:grid-cols-3 gap-6"><!--[-->`);
...
//# sourceMappingURL=treasury-Dlrivst6.mjs.map
