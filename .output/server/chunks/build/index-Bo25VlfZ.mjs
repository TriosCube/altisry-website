...
// \u2192 https://connect.altisry.co/...`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="flex-1 bg-navy-950 rounded-2xl overflow-hidden"><div class="flex items-center gap-2 px-5 py-3 border-b border-white/10"><div class="w-3 h-3 rounded-full bg-red-500"></div><div class="w-3 h-3 rounded-full bg-yellow-500"></div><div class="w-3 h-3 rounded-full bg-green-500"></div><span class="text-white/40 text-xs ml-3">${ssrInterpolate((_a = codeExamples[unref(selectedLang)]) == null ? void 0 : _a.filename)}</span></div><div class="p-6 font-mono text-sm overflow-x-auto"><pre class="text-white/80 leading-relaxed whitespace-pre-wrap">${ssrInterpolate((_b = codeExamples[unref(selectedLang)]) == null ? void 0 : _b.code)}</pre></div></div></div></div></section><section class="py-20 bg-brand-50"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="text-center mb-14"><p class="section-label">Resources</p><h2 class="section-title mb-5">Everything you need to build</h2></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"><!--[-->`);
...
//# sourceMappingURL=index-Bo25VlfZ.mjs.map
