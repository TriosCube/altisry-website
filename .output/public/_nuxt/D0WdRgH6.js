import{d as w,u as k,c as a,e as n,b as e,w as r,F as m,r as _,t as o,q as c,o as l,k as C,_ as A,f as b,n as p,y as P,l as S,A as I}from"./i3asUN5z.js";import{_ as j}from"./CgPh5ojd.js";import{_ as B}from"./DStJRX7J.js";const R={class:"py-20 bg-white"},E={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},L={class:"flex flex-col lg:flex-row gap-12 items-start"},M={class:"lg:w-2/5"},N={class:"space-y-3"},T=["onClick"],V={class:"text-xl"},H={class:"font-medium text-navy-900 text-sm"},$={key:0,class:"w-4 h-4 text-brand-600 ml-auto",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},K={class:"flex-1 bg-navy-950 rounded-2xl overflow-hidden"},Y={class:"flex items-center gap-2 px-5 py-3 border-b border-white/10"},D={class:"text-white/40 text-xs ml-3"},F={class:"p-6 font-mono text-sm overflow-x-auto"},q={class:"text-white/80 leading-relaxed whitespace-pre-wrap"},G={class:"py-20 bg-brand-50"},z={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},O={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},U=["d"],J={class:"font-bold text-navy-900 mb-2 group-hover:text-brand-600 transition-colors"},Q={class:"text-sm text-gray-600 leading-relaxed"},ne=w({__name:"index",setup(W){k({title:"Developers | Altisry",description:"Build with Altisry. REST API, SDKs, documentation, and sandbox environment. Get started in minutes."});const i=I("Node.js"),h=[{name:"Node.js",emoji:"🟩"},{name:"Python",emoji:"🐍"},{name:"Ruby",emoji:"💎"},{name:"PHP",emoji:"🐘"}],u={"Node.js":{filename:"connect.js",code:`const Altisry = require('@altisry/sdk');
